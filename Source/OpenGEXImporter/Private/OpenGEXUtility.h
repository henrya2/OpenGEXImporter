...
template <typename T>
UPackage* RetrieveAssetPackageAndName(UObject* Parent, const FString& PreferredName, const TCHAR* BackupPrefix, FName BackupName, int32 BackupIndex, FString& OutName)
{
	FString AssetName;
